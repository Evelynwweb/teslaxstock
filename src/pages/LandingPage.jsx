...
const LandingPage = () => {
  ...
  // Only the Cybertruck video slide data
  const cybertruckSlide = {
    title: 'Cybertruck',
    subtitle: 'Better Utility Than a Truck with More Performance Than a Sports Car',
    type: 'video',
    media: '/tesla-more-detail-video-showcase-6x4-truckbed.mp4',
  ...
  return (
    <div className="bg-[#09090B] text-[#E4E4E7] font-['Poppins',sans-serif] overflow-x-hidden selection:bg-white selection:text-black antialiased">
      ...
      {/* Hero — single video background (no carousel) */}
      ...
      <section className="py-24 bg-[#09090B]">
        {/* ... rest of the fleet swiper unchanged ... */}
      ...
      <style jsx>{`
        ...
        .animation-delay-300 { animation-delay: 0.24s; }
        .swiper-button-next,
        .swiper-button-prev {
